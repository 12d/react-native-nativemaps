...
public class RCTAMapMarker extends RCTAMapFeature {
    ...
    private RCTAMapCallout calloutView;
    ...
    public RCTAMapMarker(Context context) {
        super(context);
...
//        }
    ...
    public void setCalloutView(RCTAMapCallout view) {
        this.calloutView = view;
    }

    public RCTAMapCallout getCalloutView() {
