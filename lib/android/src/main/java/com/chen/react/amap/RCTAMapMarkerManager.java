...
public class RCTAMapMarkerManager extends ViewGroupManager<RCTAMapMarker> {

    public static final int SHOW_INFO_WINDOW = 1;
    public static final int HIDE_INFO_WINDOW = 2;

    public RCTAMapMarkerManager(ReactContext reactContext) {
    }

    @Override
    public String getName() {
        return "RCTAMapMarker";
    }

    @Override
    public RCTAMapMarker createViewInstance(ThemedReactContext context) {
        return new RCTAMapMarker(context);
    }

    @ReactProp(name = "coordinate")
    public void setCoordinate(RCTAMapMarker view, ReadableMap map) {
        view.setCoordinate(map);
    }

    @ReactProp(name = "title")
    public void setTitle(RCTAMapMarker view, String title) {
        view.setTitle(title);
    }

    @ReactProp(name = "description")
    public void setDescription(RCTAMapMarker view, String description) {
...
//    }
    ...
    public void setAnchor(RCTAMapMarker view, ReadableMap map) {
    ...
    public void setCalloutAnchor(RCTAMapMarker view, ReadableMap map) {
    ...
    public void setImage(RCTAMapMarker view, @Nullable String source) {
...
//    }
    ...
    public void setPinColor(RCTAMapMarker view, int pinColor) {
    ...
    public void setMarkerRotation(RCTAMapMarker view, float rotation) {
        view.setRotation(rotation);
    }

    // TODO: 16/5/19
//    @ReactProp(name = "flat", defaultBoolean = false)
//    public void setFlat(RCTAMapMarker view, boolean flat) {
//        view.setFlat(flat);
//    }

    @ReactProp(name = "draggable", defaultBoolean = false)
    public void setDraggable(RCTAMapMarker view, boolean draggable) {
        view.setDraggable(draggable);
    }

    @Override
    public void addView(RCTAMapMarker parent, View child, int index) {
        // if an <Callout /> component is a child, then it is a callout view, NOT part of the
        // marker.
        if (child instanceof RCTAMapCallout) {
            parent.setCalloutView((RCTAMapCallout) child);
        } else {
    ...
    @Override
    public void removeViewAt(RCTAMapMarker parent, int index) {
    ...
    @Override
    public void receiveCommand(RCTAMapMarker view, int commandId, @Nullable ReadableArray args) {
        switch (commandId) {
    ...
    @Override
    public void updateExtraData(RCTAMapMarker view, Object extraData) {
